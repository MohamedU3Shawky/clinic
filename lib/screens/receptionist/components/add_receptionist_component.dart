...
import 'package:egphysio_clinic_admin/screens/receptionist/components/add_receptionist_controller.dart';
...
class AddReceptionistComponent extends StatelessWidget {
  ...
  AddReceptionistController addReceptionistCont = Get.put(AddReceptionistController());

  @override
  Widget build(BuildContext context) {
    return AppScaffoldNew(
        appBartitleText: isEdit
            ? "Edit Receptionist" ///todo : Add language
            : isFromEditProfile
