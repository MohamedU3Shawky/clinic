...
import 'package:egphysio_clinic_admin/screens/receptionist/components/add_receptionist_component.dart';
    ...
    showConfirmDialogCustom(
      ...
      onAccept: (ctx) async {
        ...
        CoreServiceApis.deleteReceptionist(receptionistId: receptionist[index].receptionistId).then((value) {
          ...
          toast(value.message.trim().isEmpty ? "Receptionist Delete successfully" : value.message.trim());///TODO : Add language
