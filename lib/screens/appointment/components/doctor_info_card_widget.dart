...
class DoctorInfoCardWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Get.to(() => DoctorDetailScreen(), arguments: Doctor(doctorId: doctorInfo.doctorId ?? -1));
      },
      child: Container(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        ).paddingTop(8).visible(doctorInfo.doctorPhone?.isNotEmpty ?? false),
                        GestureDetector(
                          onTap: () {
                        ...
                        ).paddingTop(8).visible(doctorInfo.doctorEmail?.isNotEmpty ?? false),
                      ],
                    )
                  ],
                ).expand(),
