...
class ClinicInfoCardWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Get.to(() => ClinicDetailScreen(), arguments: ClinicData(id: clinicInfo.clinicId ?? -1, clinicImage: clinicInfo.clinicImage ?? "", name: clinicInfo.clinicName ?? ""));
      },
      child: Container(
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        ).paddingTop(8).visible(clinicInfo.clinicPhone?.isNotEmpty ?? false),
                        GestureDetector(
                          onTap: () {
                        ...
                        ).paddingTop(8).visible(clinicInfo.clinicAddress?.isNotEmpty ?? false),
                      ],
                    )
                  ],
                ).expand(),
