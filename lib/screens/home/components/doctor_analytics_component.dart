...
import 'package:egphysio_clinic_admin/screens/patient/all_patient_list.dart';
...
class DoctorAnalyticComponent extends StatelessWidget {
  ...
  const DoctorAnalyticComponent({Key? key, required this.homeScreenCont}) : super(key: key);
